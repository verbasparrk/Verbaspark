...
export function profileMetadata(page,url,language){
 ...
 const person={"@type":profile.seo.entityType,name:localized.name,url:canonical,...(description?{description}:{}),...(personImage?{image:personImage}:{}),...(external.length?{sameAs:external}:{})};
