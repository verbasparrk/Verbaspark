...
export const contentGroups=[
 ...
 {name:'Contact & links',items:[['contact-form','Contact form','Receive enquiries with fields you choose.','Text, email, dropdowns and more'],['contact','Contact','Make it easy to get in touch by email.','Let’s connect ↗'],['link','Link','A website, social profile, or favorite page.','Instagram ↗'],['location','Location','An address, map, and navigation link.','Find me · Open navigation ↗']]}
];
